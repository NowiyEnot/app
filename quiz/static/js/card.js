document.addEventListener("DOMContentLoaded", function() {
    const circles = [];
    const numCircles = 20;
    const mainElement = document.querySelector('main'); // Получаем элемент <main>
    ...
    for (let i = 0; i < numCircles; i++) {
        ...
        circle.src = "/static/img/Ellipse" + imageIndex + ".png";// использование случайного индекса для выбора изображения
        ...
        mainElement.appendChild(circle); // Добавляем шарики внутрь <main>
    }
